...
class PsychotypeCalculatorUnitTest {
    ...
    fun `check calculation result of two variants`() {
        val answers = arrayOf(
                TestQuestion(null, Function.Logic, TestAnswer.No),
                TestQuestion(null, Function.Emotion, TestAnswer.Maybe),
                TestQuestion(null, Function.Physics, TestAnswer.Yes),
                TestQuestion(null, Function.Will, TestAnswer.No)
        )
    ...
    fun `check calculation result of four variants`() {
        val answers = arrayOf(
                TestQuestion(null, Function.Logic, TestAnswer.Yes),
                TestQuestion(null, Function.Emotion, TestAnswer.No),
                TestQuestion(null, Function.Physics, TestAnswer.No),
                TestQuestion(null, Function.Will, TestAnswer.Yes)
        )
    ...
    fun `check philia on first function relationship`() {
        val philiaEmotion = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Pushkin, Psychotype.Parsnip)
        assertEquals("Check first emotion philia relationship", Relationship.Philia_1_Emotion, philiaEmotion)

        val philiaLogic = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Pascal, Psychotype.Lao)
        assertEquals("Check first logic philia relationship", Relationship.Philia_1_Logic, philiaLogic)

        val philiaPhysics = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Aristippus, Psychotype.Aristippus)
        assertEquals("Check first physics philia relationship", Relationship.Philia_1_Physics, philiaPhysics)

        val philiaWill = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Lenin, Psychotype.Twardowski)
    ...
    fun `check philia on second function relationship`() {
        val philiaEmotion = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Akhmatova, Psychotype.Akhmatova)
        assertEquals("Check second emotion philia relationship", Relationship.Philia_2_Emotion, philiaEmotion)

        val philiaLogic = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Rousseau, Psychotype.Socrates)
        assertEquals("Check second logic philia relationship", Relationship.Philia_2_Logic, philiaLogic)

        val philiaPhysics = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Berthier, Psychotype.Bukharin)
        assertEquals("Check second physics philia relationship", Relationship.Philia_2_Physics, philiaPhysics)

        val philiaWill = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Lao, Psychotype.Einstein)
    ...
    fun `check philia on third function relationship`() {
        val philiaEmotion = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Berthier, Psychotype.Epicurus)
        assertEquals("Check third emotion philia relationship", Relationship.Philia_3_Emotion, philiaEmotion)

        val philiaLogic = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Napoleon, Psychotype.Borgia)
        assertEquals("Check third logic philia relationship", Relationship.Philia_3_Logic, philiaLogic)

        val philiaPhysics = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Tolstoy, Psychotype.Lenin)
        assertEquals("Check third physics philia relationship", Relationship.Philia_3_Physics, philiaPhysics)

        val philiaWill = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Pushkin, Psychotype.Dumas)
    ...
    fun `check philia on forth function relationship`() {
        val philiaEmotion = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Plato, Psychotype.Lao)
        assertEquals("Check forth emotion philia relationship", Relationship.Philia_4_Emotion, philiaEmotion)

        val philiaLogic = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Dumas, Psychotype.Pushkin)
        assertEquals("Check forth logic philia relationship", Relationship.Philia_4_Logic, philiaLogic)

        val philiaPhysics = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Einstein, Psychotype.Ghazali)
        assertEquals("Check forth physics philia relationship", Relationship.Philia_4_Physics, philiaPhysics)

        val philiaWill = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Epicurus, Psychotype.Berthier)
    ...
    fun `check pseudo philia on first and second functions`() {
        val emotionRelationship = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Anderson, Psychotype.Pascal)
        assertEquals("Check 1-2 emotion pseudo philia relationship", Relationship.PseudoPhilia_1_2_Emotion, emotionRelationship)

        val logicRelationship = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Berthier, Psychotype.Epicurus)
        assertEquals("Check 1-2 logic pseudo philia relationship", Relationship.PseudoPhilia_1_2_Logic, logicRelationship)

        val physicsRelationship = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Goethe, Psychotype.Bukharin)
        assertEquals("Check 1-2 logic pseudo philia relationship", Relationship.PseudoPhilia_1_2_Physics, physicsRelationship)

        val willRelationship = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Lenin, Psychotype.Chekhov)
    ...
    fun `check pseudo philia on second and first functions`() {
        val emotionRelationship = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Tolstoy, Psychotype.Rousseau)
        assertEquals("Check 2-1 emotion pseudo philia relationship", Relationship.PseudoPhilia_2_1_Emotion, emotionRelationship)

        val logicRelationship = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Epicurus, Psychotype.Pascal)
        assertEquals("Check 2-1 logic pseudo philia relationship", Relationship.PseudoPhilia_2_1_Logic, logicRelationship)

        val physicsRelationship = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Plato, Psychotype.Borgia)
        assertEquals("Check 2-1 physics pseudo philia relationship", Relationship.PseudoPhilia_2_1_Physics, physicsRelationship)

        val willRelationship = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Chekhov, Psychotype.Napoleon)
    ...
    fun `check pseudo philia on third and forth functions`() {
        val emotionRelationship = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Berthier, Psychotype.Goethe)
        assertEquals("Check 3-4 emotion pseudo philia relationship", Relationship.PseudoPhilia_3_4_Emotion, emotionRelationship)

        val logicRelationship = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Napoleon, Psychotype.Parsnip)
        assertEquals("Check 3-4 logic pseudo philia relationship", Relationship.PseudoPhilia_3_4_Logic, logicRelationship)

        val physicsRelationship = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Lenin, Psychotype.Akhmatova)
        assertEquals("Check 3-4 physics pseudo philia relationship", Relationship.PseudoPhilia_3_4_Physics, physicsRelationship)

        val willRelationship = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Plato, Psychotype.Augustine)
    ...
    fun `check pseudo philia on forth and third functions`() {
        val emotionRelationship = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Aristippus, Psychotype.Chekhov)
        assertEquals("Check 4-3 emotion pseudo philia relationship", Relationship.PseudoPhilia_4_3_Emotion, emotionRelationship)

        val logicRelationship = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Dumas, Psychotype.Napoleon)
        assertEquals("Check 4-3 logic pseudo philia relationship", Relationship.PseudoPhilia_4_3_Logic, logicRelationship)

        val physicsRelationship = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Einstein, Psychotype.Lao)
        assertEquals("Check 4-3 physics pseudo philia relationship", Relationship.PseudoPhilia_4_3_Physics, physicsRelationship)

        val willRelationship = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Borgia, Psychotype.Plato)
    ...
    fun `check eros on first and third functions`() {
        val emotionRelationship = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Anderson, Psychotype.Berthier)
        assertEquals("Check 1-3 emotion eros relationship", Relationship.Eros_1_3_Emotion, emotionRelationship)

        val logicRelationship = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Einstein, Psychotype.Bukharin)
        assertEquals("Check 1-3 logic eros relationship", Relationship.Eros_1_3_Logic, logicRelationship)

        val physicsRelationship = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Epicurus, Psychotype.Rousseau)
        assertEquals("Check 1-3 physics eros relationship", Relationship.Eros_1_3_Physics, physicsRelationship)

        val willRelationship = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Socrates, Psychotype.Aristippus)
    ...
    fun `check eros on third and first functions`() {
        val emotionRelationship = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Chekhov, Psychotype.Rousseau)
        assertEquals("Check 3-1 emotion eros relationship", Relationship.Eros_3_1_Emotion, emotionRelationship)

        val logicRelationship = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Borgia, Psychotype.Plato)
        assertEquals("Check 3-1 logic eros relationship", Relationship.Eros_3_1_Logic, logicRelationship)

        val physicsRelationship = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Tolstoy, Psychotype.Dumas)
        assertEquals("Check 3-1 physics eros relationship", Relationship.Eros_3_1_Physics, physicsRelationship)

        val willRelationship = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Pushkin, Psychotype.Napoleon)
    ...
    fun `check eros on second and forth functions`() {
        val emotionRelationship = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Pascal, Psychotype.Aristippus)
        assertEquals("Check 2-4 emotion eros relationship", Relationship.Eros_2_4_Emotion, emotionRelationship)

        val logicRelationship = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Lenin, Psychotype.Pushkin)
        assertEquals("Check 2-4 logic eros relationship", Relationship.Eros_2_4_Logic, logicRelationship)

        val physicsRelationship = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Berthier, Psychotype.Ghazali)
        assertEquals("Check 2-4 physics eros relationship", Relationship.Eros_2_4_Physics, physicsRelationship)

        val willRelationship = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Goethe, Psychotype.Epicurus)
    ...
    fun `check eros on forth and second functions`() {
        val emotionRelationship = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Plato, Psychotype.Borgia)
        assertEquals("Check 4-2 emotion eros relationship", Relationship.Eros_4_2_Emotion, emotionRelationship)

        val logicRelationship = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Parsnip, Psychotype.Rousseau)
        assertEquals("Check 4-2 logic eros relationship", Relationship.Eros_4_2_Logic, logicRelationship)

        val physicsRelationship = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Einstein, Psychotype.Napoleon)
        assertEquals("Check 4-2 physics eros relationship", Relationship.Eros_4_2_Physics, physicsRelationship)

        val willRelationship = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Borgia, Psychotype.Goethe)
    ...
    fun `check agape on first and forth functions`() {
        val emotionRelationship = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Rousseau, Psychotype.Plato)
        assertEquals("Check 1-4 emotion agape relationship", Relationship.Agape_1_4_Emotion, emotionRelationship)

        val logicRelationship = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Einstein, Psychotype.Parsnip)
        assertEquals("Check 1-4 logic agape relationship", Relationship.Agape_1_4_Logic, logicRelationship)

        val physicsRelationship = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Epicurus, Psychotype.Akhmatova)
        assertEquals("Check 1-4 physics agape relationship", Relationship.Agape_1_4_Physics, physicsRelationship)

        val willRelationship = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Socrates, Psychotype.Rousseau)
    ...
    fun `check agape on forth and first functions`() {
        val emotionRelationship = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Goethe, Psychotype.Pushkin)
        assertEquals("Check 1-4 emotion agape relationship", Relationship.Agape_4_1_Emotion, emotionRelationship)

        val logicRelationship = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Dumas, Psychotype.Augustine)
        assertEquals("Check 1-4 logic agape relationship", Relationship.Agape_4_1_Logic, logicRelationship)

        val physicsRelationship = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Socrates, Psychotype.Chekhov)
        assertEquals("Check 1-4 physics agape relationship", Relationship.Agape_4_1_Physics, physicsRelationship)

        val willRelationship = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Epicurus, Psychotype.Lenin)
    ...
    fun `check agape on second and third functions`() {
        val emotionRelationship = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Pascal, Psychotype.Epicurus)
        assertEquals("Check 2-3 emotion agape relationship", Relationship.Agape_2_3_Emotion, emotionRelationship)

        val logicRelationship = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Rousseau, Psychotype.Ghazali)
        assertEquals("Check 2-3 logic agape relationship", Relationship.Agape_2_3_Logic, logicRelationship)

        val physicsRelationship = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Napoleon, Psychotype.Tolstoy)
        assertEquals("Check 2-3 physics agape relationship", Relationship.Agape_2_3_Physics, physicsRelationship)

        val willRelationship = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Goethe, Psychotype.Pushkin)
    ...
    fun `check agape on third and second function`() {
        val emotionRelationship = RelationshipsCalculator.getRelationship(Function.Emotion, Psychotype.Chekhov, Psychotype.Borgia)
        assertEquals("Check 3-2 emotion agape relationship", Relationship.Agape_3_2_Emotion, emotionRelationship)

        val logicRelationship = RelationshipsCalculator.getRelationship(Function.Logic, Psychotype.Akhmatova, Psychotype.Epicurus)
        assertEquals("Check 3-2 logic agape relationship", Relationship.Agape_3_2_Logic, logicRelationship)

        val physicsRelationship = RelationshipsCalculator.getRelationship(Function.Physics, Psychotype.Rousseau, Psychotype.Bukharin)
        assertEquals("Check 3-2 physics agape relationship", Relationship.Agape_3_2_Physics, physicsRelationship)

        val willRelationship = RelationshipsCalculator.getRelationship(Function.Will, Psychotype.Anderson, Psychotype.Lao)
